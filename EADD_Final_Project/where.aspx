<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="where.aspx.vb" Inherits="EADD_Final_Project.where" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
      ...
      <div class="jumbotron">
    <h1>Where</h1> 
    <p>Welcome to the Where page where you will learn all about the select </p> 
  </div>
